...
#ifndef CT_IMPSURFCHEM_masstransfer_H
#define CT_IMPSURFCHEM_masstransfer_H
 ...
 *
 */
class ImplicitSurfChem_masstransfer : public FuncEval
{
...
public:
     ...
     */
    ImplicitSurfChem_masstransfer(std::vector<InterfaceKinetics*> k);

    /**
     * Destructor. Deletes the integrator.
     */
    virtual ~ImplicitSurfChem_masstransfer();
