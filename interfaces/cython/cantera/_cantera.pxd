...
cdef extern from "cantera/kinetics/InterfaceKinetics.h":
    cdef cppclass CxxInterfaceKinetics "Cantera::InterfaceKinetics":
        ...
        void initialize_wcmodel(CxxTransport*, double,double,double,double,double,double,double,double,double,double,int,cbool,int,int,double,double,double,double,int,double,cbool,int,double,double,double,double,double,cbool) 
